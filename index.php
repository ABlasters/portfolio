...
<body>
    ...
    <a href="light"><img class="mod" src="icon/light_mode.svg" alt=""></a>
    <div id="1">
        <h1>PRÉSENTATION</h1>
    ...
    <div id="4">
        <h1>DIPLÔMES</h1>
        <p>Je suis au Lycée Marcel Dassault de Rochefort (17300) en seconde générale avec l'option science de l'ingenieur (SI). J'ai eu mon brevet des collèges avec la mention bien et la certification pix.</p>
    </div>
    <br>
    <div id="5">
        <h1>EXPÉRIENCE</h1>
